...
|update()                               |Sends an update notification to the application to prepare geometries and OpenGL szene. This method should be called only when needed (creation of entities and geometries). If multiple entities or geometries are created, use only once at the end. |
